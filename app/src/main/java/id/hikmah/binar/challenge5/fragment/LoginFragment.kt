...
import id.hikmah.binar.challenge5.viewmodel.LoginViewModel
...
class LoginFragment : Fragment() {
    ...
    private val viewModel: LoginViewModel by viewModelsFactory { LoginViewModel(userRepo, sharedPrefs) }
